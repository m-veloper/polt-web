...
export const state = {
  ...
  questions: [
    ...
    {
      q:
        "3. 본인이 외출 시 반려견이 혼자 있지 않고, 돌봐줄 다른 가족이나, 지인이 있는지?",
      a: [
        {
    ...
    {
      q:
        `5. 경제적으로 반려견을 키울 수 있는 충분한 여유가 있는지?<br>(사료, 간식, 병원비, 미용, 교육 등등)`,
      a: [
        {
    ...
    {
      q:
        "6. 원룸처럼 작은 집이 아닌 같이 살 수 있는 넓은 환경에서 거주하고 있는지?",
      a: [
        {
    ...
    {
      q:
        "7. 집 주변에 반려견을 산책시킬 수 있는 공원이나 운동장, 최소한의 산책로가 있는지?",
      a: [
        {
    ...
    {
      q:
        `8. 견종별 특성을 잘 알고 있는지?<br>(운동량이 많은지, 순한지, 공격 본능이 뛰어난지 등등)`,
      a: [
        {
          text: "대충 알고있다.",
          value: "B"
    ...
    {
      q: "11. 본인 명의 차를 소유하고 있거나, 필요시 언제든지 렌트할 수 있는지?",
      a: [
        {
    ...
    {
      q: "14. 반려견이 먹어야 할 구충제의 종류를 알고 있는지?",
      a: [
        {
    ...
    {
      q: "15. 반려견을 혼내지 않고 교육하는 방법을 알고 있는지?",
      a: [
        {
          text: "전혀 알지 못한다.",
          value: "C"
    ...
    {
      q: "16. 사회화 시기에 필요한 교육 방법을 알고 있는지?",
      a: [
        {
          text: "전혀 알지 못한다.",
          value: "C"
    ...
    {
      q: "18. 사회화 시기에 다양한 경험을 시켜줄 각오가 되어있는지?",
      a: [
        {
          text: "최대한 노력할 것이다.",
          value: "B"
    ...
    {
      q: "19. 사회화 시기에 하루 6시간 이상 떨어지지 않을 수 있는지?",
      a: [
        {
